  ...
  return (
    <div className='bg-background font-poppins h-full' data-theme="cupcake">
      ...
      <div className='p-4 text-primaryText w-svw lg:px-72'>
        ...
        <Card>
          <div className='mb-10'>
            <h1 className='text-accent text-xl mb-8 md:text-2xl xl:text-3xl text-justify'>Why we chose this SDG?</h1>
          ...
          <div className=''>
            <h1 className=' text-accent text-xl mb-8 md:text-2xl xl:text-3xl'>WHY we chose this kind of system/application?</h1>
        ...
        <Card>
          <div className='md:text-xl'>
            <h1 className='text-accent text-xl mb-8 md:text-2xl font-semibold xl:text-3xl'>Problems we want to address:</h1>

            <ul className='list-disc ml-5 xl:text-3xl'>
              <li className='font-semibold'>Energy Consumption Awareness
                <ul className=' mb-6 xl:mt-4'>
        ...
        <Card>
          ...
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify'>Persona</h1>
          ...
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify mt-16'>Empathy Map</h1>
          ...
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify mt-16'>Coming to a solution</h1>
          ...
          <div className='flex flex-col relative gap-16 mb-16 xl:grid xl:grid-cols-2 xl:grid-rows-3'>
            ...
            <div className=' border border-gray-400 bg-base-100 rounded-md p-8 md:text-xl lg:col-start-1 h-fit'>
        ...
        <Card>
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify text-accent'>Tracking electricity consumption</h1>
          ...
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify text-accent mt-6'>Electric consumption simulation</h1>
          ...
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify text-accent mt-6'>Energy saving tips</h1>
          ...
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify text-accent mt-6'>Electric consumption dashboard</h1>
          ...
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify text-accent mt-6'>Electric usage limiter</h1>
          ...
          <h1 className=' font-semibold text-xl mb-8 md:text-2xl xl:text-3xl text-justify text-accent mt-6'>On/Off interface</h1>
        ...
        <Card>
          <h1 className=' font-semibold text-xl mb-8 md:text-3xl lg:text-4xl'>Tools used</h1>
          ...
          <div className="xl:grid xl:grid-cols-4 mt-8 lg:flex gap-y-24 lg:flex-col">
            <div className="w-full lg:w-full mr-12 flex justify-center md:flex-none md:justify-center">
              <img src="https://w7.pngwing.com/pngs/885/629/png-transparent-miro-hd-logo.png" alt="MiroLogo" srcset="" className=' sm:w-32  md:w-1/3 lg:w-32 w-1/3  mb-8 lg:h-auto ' />
            </div>
          ...
          <div className="xl:grid xl:grid-cols-4 mt-8 lg:flex gap-y-24 lg:flex-col">
            ...
            <div className="w-full lg:w-full mr-12 flex justify-center md:flex-none md:justify-center">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Figma-logo.svg/1667px-Figma-logo.svg.png" alt="MiroLogo" srcset="" className='col-span-1 sm:w-32 md:w-1/3 lg:w-32 w-1/3 mb-8' />
            </div>
          ...
          <h1 className=' font-semibold text-xl mb-8 mt-16 md:text-3xl lg:text-4xl'>Wireframe Storyboard</h1>
        ...
        <Card>
          <div className='mb-6 text-base'>
            <h1 className='text-accent text-xl mb-8 font-semibold md:text-2xl lg:text-3xl'>What have we learned?</h1>
