...
export default function CampusNotes() {
  return (
    <div className='bg-background font-poppins h-full w-svw'>
      ...
      <div className='p-16 text-primaryText'>
        ...
        <Card>
          <div className='mb-10'>
            ...
            <h1 className='md:text-xl lg:text-3xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
          </div>
          <div className=''>
        ...
        <Card>
          ...
          <h1 className=' font-semibold text-4xl mb-4'>Persona</h1>
          ...
          <div className='flex justify-center items-center bg-primary w-full h-64'>
            <h1 className='font-base text-white text-3xl'>Persona Image</h1>
          </div>
          ...
          <h1 className=' font-semibold text-4xl mb-4 mt-16'>Empathy Map</h1>
          ...
          <div className='flex justify-center items-center bg-primary w-full h-64'>
            <h1 className='font-base text-white text-3xl'>Empathy Image</h1>
          </div>

          <h1 className=' font-semibold text-4xl mb-4 mt-16'>Coming to a solution</h1>
          ...
          <div className='flex flex-col relative gap-16 mb-16 lg:grid lg:grid-cols-2 lg:grid-rows-3'>
            <div className=' border border-gray-400 bg-base-100 rounded-md p-8 md:text-xl lg:row-span-1'>
              <h1 className='text-accent text-xl md:text-2xl lg:text-3xl'>Storyboard</h1>
            ...
            <div className=' border border-gray-400 bg-base-100 rounded-md p-8 md:text-xl lg:col-start-1'>
              <h1 className='text-accent text-xl md:text-2xl lg:text-3xl'>Fishbone</h1>
              <h1 className='mt-4 lg:text-3xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
            </div>
            ...
            <div className=' border border-gray-400 bg-base-100 rounded-md p-8 md:text-xl lg:col-start-1'>
              <h1 className='text-accent text-xl md:text-2xl lg:text-3xl'>Mind Mapping</h1>
              <h1 className='mt-4 lg:text-3xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
            </div>
            ...
            <div className='lg:col-start-2 lg:row-start-2'>
              <div className='flex justify-center items-center bg-primary w-full h-64'>
                <h1 className='font-base text-white text-3xl'>Fishbone Image</h1>
              </div>
            </div>
            <div>
              <div className='flex justify-center items-center bg-primary w-full h-64'>
                <h1 className='font-base text-white text-3xl'>Mind Mapping Image</h1>
              </div>
            </div>
          </div>
        ...
        <Card>
          <h1 className=' font-semibold text-2xl mb-4 md:text-3xl lg:text-4xl'>Tools used</h1>
          <h1 className='text-xl lg:text-3xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
          ...
          <div className="grid grid-cols-4 mt-12 lg:flex gap-24 ">
            ...
            <div className='col-span-3 text-xl'>
              <h1 className='font-semibold mb-2 lg:text-3xl'>Miro</h1>
          ...
          <div className="grid grid-cols-4 mt-8 lg:flex gap-24">
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Figma-logo.svg/1667px-Figma-logo.svg.png" alt="MiroLogo" srcset="" className='w-24 lg:w-32' />

            <div className='col-span-3 text-xl'>
              <h1 className='font-semibold mb-2 lg:text-3xl'>Figma</h1>
              <h1 className='lg:text-3xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
            </div>
          </div>

          <h1 className=' font-semibold text-2xl mb-4 mt-16 md:text-3xl lg:text-4xl'>Narrative Storyboard</h1>

          <div className="mb-4 text-xl lg:text-3xl">
            <h1 className='font-semibold mb-2'>Narrative One</h1>
            <h1 className=''>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
          </div>

          <div className="mb-4 text-xl lg:text-3xl">
            <h1 className='font-semibold mb-2'>Narrative Two</h1>
            <h1 className=''>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
          </div>

          <div className="mb-4 text-xl lg:text-3xl">
            <h1 className='font-semibold mb-2'>Narrative Three</h1>
            <h1 className=''>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
          </div>

          <h1 className=' font-semibold text-2xl mb-4 mt-16 md:text-3xl lg:text-4xl'>Wireframe Storyboard</h1>
          <h1 className='text-xl lg:text-3xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque feugiat orci libero, et rutrum elit scelerisque ut. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</h1>
